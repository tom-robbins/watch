...
class location_server():
    ...
    def start_listeners(self):
        self.northeast = Popen("nc -l 8000 | sed 's/^/ne: /'", shell=True)
        self.southeast = Popen("nc -l 8001 | sed 's/^/se: /'", shell=True)
        self.southwest = Popen("nc -l 8002 | sed 's/^/sw: /'", shell=True)
